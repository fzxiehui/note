...
class BlackboardWriter(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, name="Writer"):
        ...
        self.blackboard.register_key(key="dudette", access=py_trees.common.Access.WRITE)
    ...
    def update(self):
        ...
        try:
            ...
            print("Write Get:", self.blackboard.dudette)
        except AttributeError:
            pass
        try:
            # client has no read / write access
            self.blackboard.dudette = random.randint(1, 999)
            print("Write Set:", self.blackboard.dudette)
        except AttributeError:
            pass
...
class ParamsAndState(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        print("ParamsAndState Get:", self.blackboard.dudette)
        self.blackboard.dudette = random.randint(1, 999)
        print("ParamsAndState Set:", self.blackboard.dudette)
        return py_trees.common.Status.SUCCESS
...
if __name__ == "__main__":
    ...
    """ blackboard Client register key """
